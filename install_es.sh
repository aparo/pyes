...
wget -c --no-check-certificate https://download.elasticsearch.org/elasticsearch/elasticsearch/elasticsearch-1.0.0.tar.gz
tar xfvz elasticsearch-1.0.0.tar.gz
mv elasticsearch-1.0.0 elasticsearch
#elasticsearch/bin/plugin -install lukas-vlcek/bigdesk 
elasticsearch/bin/plugin -install mobz/elasticsearch-head
elasticsearch/bin/plugin -install elasticsearch/elasticsearch-lang-python/2.0.0.RC2
elasticsearch/bin/plugin -install elasticsearch/elasticsearch-lang-javascript/2.0.0.RC2
elasticsearch/bin/plugin -install elasticsearch/elasticsearch-mapper-attachments/2.0.0.RC2
elasticsearch/bin/plugin -install elasticsearch/elasticsearch-transport-thrift/2.0.0.RC2
elasticsearch/bin/plugin -install royrusso/elasticsearch-HQ
elasticsearch/bin/plugin -install elasticsearch/elasticsearch-river-twitter/2.0.0.RC2
