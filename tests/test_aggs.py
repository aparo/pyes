...
class AggsSearchTestCase(ESTestCase):
    def setUp(self):
        ...
        self.conn.indices.put_mapping(
            self.document_type, {'properties': self.get_default_mapping()}, self.index_name)
    ...
    def test_missing_agg(self):
        ...
        resultset = self.conn.search(
            query=q, indices=self.index_name, doc_types=[self.document_type])
